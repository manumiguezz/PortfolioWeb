...
class AboutMe extends StatelessWidget {
  ...
  final double aboutMeDescriptionFontSize;
  final double aboutMeTitleFontSize;
  const AboutMe({
    super.key, 
    required this.aboutMeDescriptionFontSize, 
    required this.aboutMeTitleFontSize
  });
